 ...
 * @author tnikolay
 */
public class TestFileUNCPath extends CamelTestSupport{
   @Test 
...
protected RouteBuilder createRouteBuilder() throws Exception {
    return new RouteBuilder() {
        public void configure() throws Exception {
            ...
            from("direct:reports").process(new TestFileUNCPath.ProcessReport()).to("file:\\\\gk-domain\\dfsroot\\homes_igb\\tnikolay\\test-reports", "mock:result");
        }
    };
}
